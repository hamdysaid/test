...
@Component({
  selector: 'EventHallView',
  templateUrl: './EventHallView.component.html',
  styleUrls: ['./EventHallView.component.css']
})
export class EventHallViewComponent implements OnInit {
  evendId:number ;
  ...
  constructor(private _hallService: HallService, private _toastService: ToastrService,  private _routr:Router,    private _activatedRoute:ActivatedRoute) {
