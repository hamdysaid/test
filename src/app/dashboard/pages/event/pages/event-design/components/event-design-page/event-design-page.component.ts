...
import { Hall, Place, PlaceMarker } from 'src/app/models/hall';
...
@Component({
  selector: 'app-event-design-page',
  templateUrl: './event-design-page.component.html',
  styleUrls: ['./event-design-page.component.css']
})
export class EventDesignPageComponent implements OnInit {
  eventId = 0;
  counter = 0;
