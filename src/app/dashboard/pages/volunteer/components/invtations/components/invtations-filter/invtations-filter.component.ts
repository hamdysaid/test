...
@Component({
  selector: 'app-invtations-filter',
  templateUrl: './invtations-filter.component.html',
  styleUrls: ['../../../volunteer-list/components/volunteer-list-page/volunteer-list-page.component.css','./invtations-filter.component.css']
})
export class InvtationsFilterComponent implements OnInit{
  ...
  constructor(private _stateService : StateMachineService, private _invitationservice:invitationservice, protected _degreeService:DegreeService, protected _genderService: GenderService, protected _principalityService:PrincipalityService) {
  ...
  submit(){
    ...
    this._invitationservice.getPage(1, this.form.value);
