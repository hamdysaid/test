export const environment = {
    production: true,
    API_URL : "http://localhost:8848/api/",
    API_URL_HUB : "http://localhost:8848/",
    imageEndPoint: {
        normal: "http://localhost:8848/images/",
        med: "http://localhost:8848/images/Thumbs/med/",
        small: "http://localhost:8848/images/Thumbs/small/",
    },
    endPoint: {
        notification: {
